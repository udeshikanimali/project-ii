...
import 'package:healthspace_test1/sign_in_screens/sign_up_donor_screen_4.dart';
import 'package:healthspace_test1/sign_in_screens/sign_up_patient_screen_4.dart';
import 'package:percent_indicator/linear_percent_indicator.dart';

class SignUp_Donor_Screen_3 extends StatefulWidget {
  const SignUp_Donor_Screen_3({Key? key}) : super(key: key);

  @override
  State<SignUp_Donor_Screen_3> createState() => _SignUp_Donor_Screen_3State();
}

class _SignUp_Donor_Screen_3State extends State<SignUp_Donor_Screen_3> {
  @override
              ...
              onPressed: () {
                if (_formKey.currentState!.validate()) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => const SignUp_Donor_Screen_4()));
                }
