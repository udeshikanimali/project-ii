    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          const SizedBox(height: 10.0,),
          const Text('Settings > Edit Profile > Change Email', style: TextStyle(fontSize: 15.0 , color: Colors.white), textAlign: TextAlign.center),
          const SizedBox(height: 10.0,),
          const Padding(
            padding: EdgeInsets.only(left: 30 , right: 30 , top: 30),
            child: Text('New Email:' , style: TextStyle(fontSize: 15.0 , color: Colors.white) , textAlign: TextAlign.left,),
          ),
          const SizedBox(height: 10.0,),
          Padding(
