    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          SizedBox(height: 10.0,),
          Text('Settings > Password & Security > Change Password', style: TextStyle(fontSize: 15.0 , color: Colors.white), textAlign: TextAlign.center),
          SizedBox(height: 10.0,),
          Padding(
            padding: const EdgeInsets.only(left: 30 , right: 30 , top: 30),
            child: Text('Enter Current Password:' , style: TextStyle(fontSize: 15.0 , color: Colors.white) , textAlign: TextAlign.left,),
          ),
          SizedBox(height: 10.0,),
          Padding(
