...
class AdminRemoveAccount extends StatelessWidget {
  const AdminRemoveAccount({Key? key}) : super(key: key);
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Text('Remove Account', style: TextStyle(fontSize: 15.0 , color: Colors.white), textAlign: TextAlign.center),
                    SizedBox(height: 10.0,),
                    Container(
                      child: Column(
