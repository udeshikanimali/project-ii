              ...
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Text('Patients', style: TextStyle(fontSize: 15.0 , color: Colors.white), textAlign: TextAlign.center),
                    SizedBox(height: 10.0,),
                    Container(
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            child: Center(child: Text('200' , style: TextStyle(fontSize: 20.0 , color: Colors.white), textAlign: TextAlign.center)),
                            width: 50,
                            height: 50,
                            decoration: BoxDecoration(
