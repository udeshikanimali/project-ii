...
import 'package:healthspace_test1/dashboard/hos_verify.dart';


class AdminHospitals extends StatelessWidget {
  const AdminHospitals({Key? key}) : super(key: key);
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Text('Hospitals', style: TextStyle(fontSize: 15.0 , color: Colors.white), textAlign: TextAlign.center),
                    SizedBox(height: 10.0,),
                    Container(
                      child: Column(
                        ...
                        children: [
                          //SizedBox(height: 30,),
                          Text('Total Hospitals ' , style: TextStyle(fontSize: 15.0 , color: Colors.white), textAlign: TextAlign.center ,),
                          Container(
                            child: Center(child: Text('70' , style: TextStyle(fontSize: 20.0 , color: Colors.white), textAlign: TextAlign.center)),
                            width: 50,
                            height: 50,
                            decoration: BoxDecoration(
