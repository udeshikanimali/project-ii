              ...
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Text('Admin Dashboard>Switch Request', style: TextStyle(fontSize: 15.0 , color: Colors.white), textAlign: TextAlign.center),
                    SizedBox(height: 10.0,),
                    Container(
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text('Account Name: ' , style: TextStyle(fontSize: 15.0 , color: Colors.white), textAlign: TextAlign.center ,),
                              Container(
                                width: 150,
                                height: 20,
                                decoration: BoxDecoration(
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceAround,
                            children: [
                              Text('Switch To: ' , style: TextStyle(fontSize: 15.0 , color: Colors.white), textAlign: TextAlign.center ,),
                              Container(
                                width: 150,
                                height: 20,
                                decoration: BoxDecoration(
