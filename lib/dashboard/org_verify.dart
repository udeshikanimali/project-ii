...
class OrgVerify extends StatelessWidget {
  const OrgVerify({Key? key}) : super(key: key);
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Text('Admin Dashboard>Organization>\n Verify Account', style: TextStyle(fontSize: 15.0 , color: Colors.white), textAlign: TextAlign.center),
                    SizedBox(height: 10.0,),
                    Container(
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text('Name: ' , style: TextStyle(fontSize: 15.0 , color: Colors.white), textAlign: TextAlign.center ,),
                              Container(
                                width: 150,
                                height: 20,
                                decoration: BoxDecoration(
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceAround,
                            children: [
                              Text('Verification \n Cetificate: ' , style: TextStyle(fontSize: 15.0 , color: Colors.white), textAlign: TextAlign.center ,),
                              Container(
                                width: 150,
                                height: 20,
                                decoration: BoxDecoration(
